...
public object CloudAgeVerificationServiceGrpcKt {
  ...
  public class CloudAgeVerificationServiceCoroutineStub @JvmOverloads constructor(
     ...
     */
    public suspend fun cloudAge(requests: Flow<CloudAgeRequest>, headers: Metadata = Metadata()): CloudAgeResponse = clientStreamingRpc(
      channel,
  ...
  public abstract class CloudAgeVerificationServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for cloud.v1.CloudAgeVerificationService.CloudAge.
     *
     ...
     *        it more than once.
     */
    public open suspend fun cloudAge(requests: Flow<CloudAgeRequest>): CloudAgeResponse = throw StatusException(UNIMPLEMENTED.withDescription("Method cloud.v1.CloudAgeVerificationService.CloudAge is unimplemented"))
