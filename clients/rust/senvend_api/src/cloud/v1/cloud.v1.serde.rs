...
impl serde::Serialize for CloudVersionRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.version_request.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("cloud.v1.CloudVersionRequest", len)?;
        if let Some(v) = self.target.as_ref() {
            struct_ser.serialize_field("target", v)?;
        }
        if let Some(v) = self.version_request.as_ref() {
            struct_ser.serialize_field("versionRequest", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CloudVersionRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "target" => Ok(GeneratedField::Target),
                            "versionRequest" | "version_request" => Ok(GeneratedField::VersionRequest),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CloudVersionRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cloud.v1.CloudVersionRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CloudVersionRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut target__ = None;
                let mut version_request__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Target => {
                            if target__.is_some() {
                        ...
                        GeneratedField::VersionRequest => {
                            if version_request__.is_some() {
                                return Err(serde::de::Error::duplicate_field("versionRequest"));
                            }
                            version_request__ = map_.next_value()?;
                        }
                    }
                }
                Ok(CloudVersionRequest {
                    target: target__,
                    version_request: version_request__,
                })
            }
        }
        deserializer.deserialize_struct("cloud.v1.CloudVersionRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CloudVersionResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.version_response.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("cloud.v1.CloudVersionResponse", len)?;
        if let Some(v) = self.version_response.as_ref() {
            struct_ser.serialize_field("versionResponse", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CloudVersionResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "versionResponse" | "version_response" => Ok(GeneratedField::VersionResponse),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CloudVersionResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cloud.v1.CloudVersionResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CloudVersionResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut version_response__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::VersionResponse => {
                            if version_response__.is_some() {
                                return Err(serde::de::Error::duplicate_field("versionResponse"));
                            }
                            version_response__ = map_.next_value()?;
                        }
                    }
                }
                Ok(CloudVersionResponse {
                    version_response: version_response__,
                })
            }
        }
        deserializer.deserialize_struct("cloud.v1.CloudVersionResponse", FIELDS, GeneratedVisitor)
    }
}
