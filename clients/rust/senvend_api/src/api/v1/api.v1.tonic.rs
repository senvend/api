...
*/
        pub async fn age(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::AgeRequest>,
        ) -> std::result::Result<tonic::Response<super::AgeResponse>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/api.v1.AgeVerificationService/Age",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("api.v1.AgeVerificationService", "Age"));
...
*/
        async fn age(
            &self,
            request: tonic::Request<tonic::Streaming<super::AgeRequest>>,
        ) -> std::result::Result<tonic::Response<super::AgeResponse>, tonic::Status>;
    }
    ///
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/api.v1.AgeVerificationService/Age" => {
                    ...
                    impl<
                        T: AgeVerificationService,
                    > tonic::server::ClientStreamingService<super::AgeRequest>
                    for AgeSvc<T> {
                        type Response = super::AgeResponse;
    ...
    pub const SERVICE_NAME: &str = "api.v1.AgeVerificationService";
...
*/
        pub async fn pay(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::PayRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::PayResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/api.v1.PayService/Pay");
            let mut req = request.into_streaming_request();
            req.extensions_mut().insert(GrpcMethod::new("api.v1.PayService", "Pay"));
...
pub mod pay_service_server {
    ...
    pub trait PayService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type PayStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::PayResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /** Initiates a payment process on the SENVEND Terminal
*/
        async fn pay(
            &self,
            request: tonic::Request<tonic::Streaming<super::PayRequest>>,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/api.v1.PayService/Pay" => {
                    #[allow(non_camel_case_types)]
                    struct PaySvc<T: PayService>(pub Arc<T>);
                    impl<
                        T: PayService,
                    > tonic::server::StreamingService<super::PayRequest> for PaySvc<T> {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "api.v1.PayService";
